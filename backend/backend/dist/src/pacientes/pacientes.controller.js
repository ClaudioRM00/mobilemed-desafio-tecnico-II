...
let PacientesController = class PacientesController {
    ...
    constructor(pacientesService, createPacienteUseCase, updatePacienteUseCase) {
...
exports.PacientesController = PacientesController = __decorate([
    ...
    __metadata("design:paramtypes", [pacientes_service_1.PacientesService,
        create_paciente_use_case_1.CreatePacienteUseCase,
        update_paciente_use_case_1.UpdatePacienteUseCase])
], PacientesController);
